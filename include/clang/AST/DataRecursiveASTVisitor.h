...
DEF_TRAVERSE_TYPE(ReflectionTransformType, { TRY_TO(TraverseType(T->getReflectedType())); })
...
DEF_TRAVERSE_TYPELOC(ReflectionTransformType, { TRY_TO(TraverseTypeLoc(TL.getReflTInfo()->getTypeLoc())); })
