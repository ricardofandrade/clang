...
ReflexprExpr::getMetaobjectKindName(MetaobjectKind MoK) {
  switch(MoK) {
    ...
    case MOK_MemberTypeAlias:    return "MemberTypeAlias";
    case MOK_MemberRecord:       return "MemberRecord";
    case MOK_MemberRecordAlias:  return "MemberRecordAlias";
    case MOK_MemberClass:        return "MemberClass";
    case MOK_MemberClassAlias:   return "MemberClassAlias";
    case MOK_MemberEnum:         return "MemberEnum";
    case MOK_MemberEnumAlias:    return "MemberEnumAlias";
